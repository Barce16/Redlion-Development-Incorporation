                    ...
                    <form action="{{ route('transactions.store') }}" method="POST" class="space-y-6" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <select name="customer_id" class="block w-full px-4 py-2 border border-gray-300
                                    ...
                                    @foreach($customers as $customer)
                                        <option value="{{ $customer->id }}"
                                            {{ (old('customer_id') == $customer->id) || (isset($selectedCustomer) && $selectedCustomer == $customer->id) ? 'selected' : '' }}>
                            ...
                            <div>
                                ...
                                <input id="amount_due" type="number" name="amount_due" value="{{ old('amount_due') }}" step="0.01" readonly
                            ...
                            <div>
                                ...
                                <input id="amount_paid" type="number" name="amount_paid" value="{{ old('amount_paid') }}" step="0.01"
                                    class="block w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg
                                    dark:bg-gray-700 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500">
                            ...
                            <div>
                                ...
                                <input id="remaining_balance" type="number" name="remaining_balance" value="{{ old('remaining_balance') }}" step="0.01" readonly
                                    class="block w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg
                                    dark:bg-gray-700 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500">
                            </div>
                            ...
                            <div>                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Receipt / Screenshot</label>
                                <input type="file" name="attachment_path" accept="image/*,application/pdf" class="block w-full text-sm text-gray-700">
                            </div>

                            <div>                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Recorded By</label>
                                <select name="recorded_by" class="block w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-700 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500">
                                    ...
                                    @foreach(App\Models\User::all() as $user)
                                        <option value="{{ $user->id }}" {{ old('recorded_by') == $user->id ? 'selected' : '' }}>{{ $user->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div>
                                ...
                                <select id="payment_type" name="payment_type" class="block w-full px-4 py-2 border border-gray-300
                                    ...
                                    <option value="card" {{ old('payment_type') == 'card' ? 'selected' : '' }}>Card (Debit/Credit)</option>
                                </select>
                            ...
                            <div id="card_fields" class="space-y-4 hidden">
                                <div>
                                    ...
                                    <input type="text" name="card_type" value="{{ old('card_type') }}" placeholder="Visa, Mastercard, etc."
                                        class="block w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg
                                        dark:bg-gray-700 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500">
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Last 4 digits</label>
                                    <input type="text" name="card_last4" value="{{ old('card_last4') }}" maxlength="4"
                                        class="block w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg
                                        dark:bg-gray-700 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500">
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="terminal_info" value="{{ old('terminal_info') }}" placeholder="e.g. BDO, Maya"
                                        class="block w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg
                                        dark:bg-gray-700 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500">
                                </div>
                            </div>
                        ...
                        <div class="flex gap-4 justify-end">
                            <a href="{{ route('transactions.index') }}" class="px-6 py-2 border border-gray-300 dark:border-gray-600
                            ...
                            document.addEventListener('DOMContentLoaded', function () {
                                ...
                                invoiceSelect?.addEventListener('change', function () {
                                    ...
                                    if (opt && opt.dataset) {
                                        ...
                                        const propTitle = opt.dataset.propertyTitle;
